...
function CreatePasswordForm({ email, password, setPassword, confirmPassword, setConfirmPassword, error, loading, onSubmit, onBack }) {
  return (
    <motion.form
    ...
    >
      ...
      <div className="flex gap-3">
        ...
        >
          {loading ? <LoadingSpinner text="Creating..." /> : 'Create Password & Sign In'}
        </motion.button>
      </div>
    </motion.form>
  )
